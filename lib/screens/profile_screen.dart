              ...
              state is GetUserLoading
                  ...
                  ? ListView(
                    children: [
                      ...
                      ListTile(title: Text(state.user.name), leading: const Icon(Icons.person)),
                      const SizedBox(height: 16),

                      ListTile(title: Text(state.user.email), leading: const Icon(Icons.email)),
                      const SizedBox(height: 16),

                      ListTile(title: Text(state.user.phone), leading: const Icon(Icons.phone)),
                      const SizedBox(height: 16),
